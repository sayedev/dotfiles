...
local numberedWorkspaces = NUM_WPM * 2 -- 2 monitors currently carry numbered workspaces (workspaces.lua)
...
-- Move active window to workspace number (and follow), old-style
for i = 1, numberedWorkspaces do
    local key = i % 10
...
hl.bind(mainMod .. " + E",          hl.dsp.exec_cmd(launchPrefix .. TERMINAL))
hl.bind(mainMod .. " + C",          hl.dsp.exec_cmd(launchPrefix .. CALCULATOR))
hl.bind("XF86Calculator",           hl.dsp.exec_cmd(launchPrefix .. CALCULATOR))
hl.bind("CONTROL + SHIFT + Escape", hl.dsp.exec_cmd(launchPrefix .. TERMINAL .. " -e btop"))
hl.bind(mainMod .. " + Z",          hl.dsp.exec_cmd(noctCall .. "settings-toggle"))
hl.bind(mainMod .. " + W",          hl.dsp.exec_cmd(noctCall .. "panel-toggle wallpaper"))
hl.bind(mainMod .. " + B",          hl.dsp.exec_cmd(noctCall .. "panel-toggle noctalia/wallhaven:browser"))
hl.bind(mainMod .. " + X",          hl.dsp.exec_cmd(noctCall .. "panel-toggle control-center"))
hl.bind(mainMod .. " + TAB",        hl.dsp.exec_cmd(noctCall .. "panel-toggle launcher"))
...
-- Focus on workspace number (direct jump, old-style)
for i = 1, numberedWorkspaces do
    local key = i % 10
...
-- Gaming workspace
hl.bind(mainMod .. " + R",         hl.dsp.focus({ workspace = "name:gaming" }))
hl.bind(mainMod .. " + SHIFT + R", hl.dsp.window.move({ workspace = "name:gaming" }))
